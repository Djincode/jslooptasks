// 2. Kütlə çəki indeksini (BMİ) hesablayan funksiya yaradın. Funksiya 2 arqument qəbul etləmlidir (weight (in kg), height (in meter)) və kütlə çəki indeksini "return" etməlidir.



// Bir array icinde olan butun elementlerin cemini tapan function yazin. Arrayi parametr olaraq alsin

// Bir arrayin en boyuk elementini tapin .  Arrayi parametr olaraq alsin (return)

// Bir arrayin elementlerinin hasilini tapan bir funksiya yazin (return)

// Icinde meyveler olan bir arrayin elementlerini ters ceviren bir function yazin
